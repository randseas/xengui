...
This project is heavily inspired by [github.com/emilk/egui](https://github.com/emilk/egui), a fantastic immediate mode GUI library. While XenGui is built from the ground up with its own architecture, the design philosophy and the ergonomics of `egui` served as a significant inspiration.
